...
export const metadata: Metadata = {
  title: 'Terms of Service — ZenFocus',
  description: 'Terms of Service for ZenFocus by Nuurax.',
};
  ...
  return (
    <div style={{
      ...
      <div style={sectionStyle}>
        ...
        <p style={textStyle}>
          By accessing and using ZenFocus, you agree to be bound by these Terms of Service. If you do not
          agree to these terms, please do not use the application. ZenFocus is a product developed and maintained
          by Nuurax.
        </p>
      </div>
      ...
      <div style={sectionStyle}>
        ...
        <p style={textStyle}>
          ZenFocus is a free, browser-based productivity dashboard designed for developers and students. It
      ...
      <div style={sectionStyle}>
        ...
        <p style={textStyle}>
          ...
          permanently delete your ZenFocus settings, tasks, and progress.
        </p>
      </div>
      ...
      <div style={sectionStyle}>
        ...
        <p style={textStyle}>
          ZenFocus may display affiliate links and recommendations for third-party services, including but not
      ...
      <div style={sectionStyle}>
        ...
        <p style={textStyle}>
          All content, design, and code of ZenFocus are the intellectual property of Nuurax. You may not
      ...
      <div style={sectionStyle}>
        ...
        <p style={textStyle}>
          ZenFocus is provided &quot;as is&quot; without warranties of any kind. We do not guarantee uninterrupted or
      ...
      <div style={sectionStyle}>
        ...
        <p style={textStyle}>
          Nuurax shall not be liable for any damages arising from the use or inability to use ZenFocus,
      ...
      <div style={sectionStyle}>
        ...
        <p style={textStyle}>
          Nuurax reserves the right to modify these terms at any time. Continued use of ZenFocus after changes
